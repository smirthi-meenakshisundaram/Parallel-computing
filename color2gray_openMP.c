...
void colorToGrayscale(unsigned char *gray_img, unsigned char * color_img, int width, int height, int thread_count);
...
scanf("%d",&thread_count);
   ...
   colorToGrayscale(gray_img, color_img, width, height,thread_count);
