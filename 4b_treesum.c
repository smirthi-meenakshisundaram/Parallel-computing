...
block_size = times % thread_count == 0 ? times/thread_count : 
times/thread_count + 1;
...
if (pthread_create(&thread_handlers[thread], NULL, 
computingGlobalSum_pthreads, (void *)threadID)){
